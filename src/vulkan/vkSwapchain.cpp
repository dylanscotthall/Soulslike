...
void vSwapchain::createFramebuffers(VkRenderPass renderPass) {
  resizeSwapchainFrameBuffersToSwapchainImageViews();
...
vSwapchain::getSwapchainFramebuffers() const noexcept {
